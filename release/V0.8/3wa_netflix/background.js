...
//setTimeout(function(){
  ...
  window['my_netflix_fontspace'] = 0; //Default 字距 letter-spacing 
  ...
  //字距
  if(appClass.method.getMemory('my_netflix_fontspace')!=null)
  {
    //從 memory 取字距
    window['my_netflix_fontspace'] = parseFloat(appClass.method.getMemory('my_netflix_fontspace'));
  }
  window['my_netflix_fontspace'] = (window['my_netflix_fontspace']>=50)?50:window['my_netflix_fontspace'];
  window['my_netflix_fontspace'] = (window['my_netflix_fontspace']<=-50)?-50:window['my_netflix_fontspace'];
  //註冊style到 head
...
<style reqc='s'>   
  ...
  appClass.method.$("body").prepend(" \
    <div reqc='my_netflix_controller_div' class='my_netflix_controller_class'> \
      ...
      <br> \
      SUB (大小)   <span reqc='my_netflix_fontsize_span'>"+window['my_netflix_fontsize']+"</span><br> \
      ...
      <br> \
      SUB (字距)   <span reqc='my_netflix_fontspace_span'>"+window['my_netflix_fontspace']+"</span><br> \
      <input class='my_netflix_fontspace_input_range_class' reqc='my_netflix_fontspace_input' type='range' min='-50' max='50' step='1' value='"+window['my_netflix_fontspace']+"'> \
      <br> \
