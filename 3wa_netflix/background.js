function run_3wa_netflix() {
    ...
    //console.log(window['isRun_3wa_netflix']);
    // 注入 jQuery 3.6.0 
        ...
        method: {
            ...
            "loadUIInit": function () { //要 bind UI                
                ...
                if ($("img[reqc='fixCURL']").length == 0) {
                    ...
                    $("body").prepend("<img reqc='fixCURL' style='display:none;position:absolute;z-index:-1;'>");
                    ...
                    if (typeof (window.URL.createObjectURL.my3WA) == "undefined") {                    
                        window.my_netflix_URLCREATEOBJECTURL = window.URL.createObjectURL;
                        //console.log("Register:window.URL.createObjectURL ...");
                        ...
                        window.URL.createObjectURL.my3WA = true;
                        ...
                        if (window.my_netflix_XHROPEN == null) {                        
                            ...
                            window.XMLHttpRequest.prototype.open = function () {
                                ...
                                this.addEventListener('load', function () {
                                    ...
                                    if (this.responseType == '' && this.response.indexOf('ttp:contentProfiles') != -1) {
                                        //發現字幕了
                                        ...
                                        //if (window.localStorage.getItem("my_netflix_sub2_Click_DT") != null) {
                                            ...
                                            {
                                                //第一字幕沒延遲
                                                //var movieID = appClass.method.get_between(this.response,'movieID="','"');
                                                var movieID = window.localStorage.getItem("movieID");
                                                //console.log("TEST");
                                                //console.log(movieID);
                                                var subTitle = window.localStorage.getItem("my_netflix_sub1");
                                                window.localStorage.setItem("my_netflix___SUB[" + movieID + "][" + subTitle + "]", this.response);
                                            }
                                       // }                                        
                                    }
    ...
    */
    ...
    appClass.interval.keepLoadUI_Timer = 100;
    ...
    }, appClass.interval.keepLoadUI_Timer);
  ...
  @keyframes shake{
    ...
    appClass.interval.subtitleInterval = setInterval(function () {
        ...
        */
        ...
        //如果第一字幕已在 memory my_netflix___SUB[movieID][字幕] 直接解晰
        if (localStorage["my_netflix___SUB[" + appClass.method.getMovieID() + "][" + appClass.flag.sub1 + "]"] != null) {
            //直接從 XML 解內容
            //此時有可能回上頁，沒有 $("video")
            if ($("video").length == 0) return;
            var dt = $("video")[0].currentTime;
            var txt = appClass.method.xmlSubParse(localStorage.getItem("my_netflix___SUB[" + appClass.method.getMovieID() + "][" + appClass.flag.sub1 + "]"), dt);
            //console.log(txt);
            window['lastWord_a'] = txt;
            // Issue 90、六人行英文 CC 字幕，有全大寫的問題
            if (window['my_netflix_auto_fix_english_first_letter_case'] == 'true' && (appClass.flag.sub1 == '英語 (CC)' || appClass.flag.sub1 == '英語')) {
                //如果是 英語 CC 才要處理
        ...
        if (appClass.flag.sub2 != null && appClass.flag.sub2 != "關閉" && appClass.flag.sub1 != appClass.flag.sub2) {
            ...
            if (localStorage["my_netflix___SUB[" + appClass.method.getMovieID() + "][" + appClass.flag.sub2 + "]"] != null) {
                ...
                // Issue 90、六人行英文 CC 字幕，有全大寫的問題
                if (window['my_netflix_auto_fix_english_first_letter_case'] == 'true' && (appClass.flag.sub2 == '英語 (CC)' || appClass.flag.sub2 == '英語')) {
                    //如果是 英語 CC 才要處理
