        ...
        */
        ...
        if (window['lastWord_a'] != "" || window['lastWord_b'] != "" || window['lastImage_a'] != "" || window['lastImage_b'] != "") {
            ...
            */
            ...
            //console.log("window['lastWord_a']: " + window['lastWord_a']);
            //console.log("window['lastImage_a']: " + window['lastImage_a']);
            //console.log("window['lastWord_b']: " + window['lastWord_b']);
            //console.log("window['lastImage_b']: " + window['lastImage_b']);
            //console.log("");
            ...
            //塞圖片字幕??
            if ((window['lastWord_a'] == null || window['lastWord_a'] == "") && window['lastImage_a'] != null) {
            ...
            if ((window['lastWord_b'] == null || window['lastWord_b'] == "") && window['lastImage_b'] != null) {
