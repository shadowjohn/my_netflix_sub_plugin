function run_3wa_netflix() {
    ...
    var appClass = {
                ...
                */
                ...
                li_a.unbind("click").bind("click", { "dom": dom, "obj": obj }, function (e) {
                    ...
                    e.data.dom.find(this_href).css({
                        ...
                        'display': 'block',
                        'margin-top': '10px',
                        'pointer-events': 'auto' //不能設穿透，任何東西都無法點
                    });
                    return false;
                }); //a click
                if (obj.show != null) {
        ...
        "interval": { //用來放一堆無腦 interval 的好地方
            ...
            subtitleInterval: null, // 主要字幕一直出現的 interval，時間相當短 50ms
        },
        "flag": {
    ...
    appClass.interval.subtitleInterval = setInterval(function () {
        ...
        if (appClass.flag.mainSubHasData == false) {
            ...
            if ($("div[data-uia='selector-audio-subtitle']").length != 0) {
                ...
                $("#subMain_div").find("div[reqc='我的字幕選單'] li[data-uia^='audio-item']").unbind("click").click(function () {
                ...
                //註冊主要字幕被點到
                $("#subMain_div").find("div[reqc='我的字幕選單'] div[reqc='主要字幕'] li").unbind("click").click(function () {
                    var data_uiaName = $(this).attr('data-uia');
                    $("div[reqc='原本的字幕選單'] li[data-uia='" + data_uiaName + "']").trigger("click");
                    //然後重建字幕選單
                    $("#subMain_div").empty();
        ...
        if ($(".image-based-subtitles svg image").length > 0) { //2022/03/18以前的舊版，圖片型字幕            
        ...
        else if ($(".player-timedtext-text-container span").length > 0) { //2022/03/21 新版 0.7 文字型字幕
            //2022/03/21 新版 0.7
            ...
            */
            ...
            var all3waDoms = $("div[reqc='my3waSubDiv'] *");
